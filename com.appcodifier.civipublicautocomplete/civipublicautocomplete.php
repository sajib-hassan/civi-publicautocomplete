...
function civipublicautocomplete_civicrm_buildForm($formName, &$form) {
    ...
    CRM_Core_Resources::singleton()->addStyle('
        #crm-container.crm-public input.huge.ui-autocomplete-input {
            background: url(data:image/png;base64,) center right no-repeat, -moz-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url(data:image/png;base64,) center right no-repeat, -webkit-gradient(linear, left bottom, left top, color-stop(0, #eee), color-stop(0.5, #fff));
            background: url(data:image/png;base64,) center right no-repeat, -webkit-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url(data:image/png;base64,) center right no-repeat, -ms-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url(data:image/png;base64,) center right no-repeat, -o-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url(data:image/png;base64,) center right no-repeat, linear-gradient(top, #fff 0%, #eee 50%);
            padding-right: 16px;
        }
        #crm-container.crm-public input.huge.ui-autocomplete-input.ui-autocomplete-loading{
            background-image: url("/sites/all/modules/civicrm/i/loading.gif"), -moz-linear-gradient(center top , #eee 1%, #fff 15%);
            background: url("/sites/all/modules/civicrm/i/loading.gif") center right no-repeat, -moz-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url("/sites/all/modules/civicrm/i/loading.gif") center right no-repeat, -webkit-gradient(linear, left bottom, left top, color-stop(0, #eee), color-stop(0.5, #fff));
            background: url("/sites/all/modules/civicrm/i/loading.gif") center right no-repeat, -webkit-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url("/sites/all/modules/civicrm/i/loading.gif") center right no-repeat, -ms-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url("/sites/all/modules/civicrm/i/loading.gif") center right no-repeat, -o-linear-gradient(center bottom, #eee 0%, #fff 50%);
            background: url("/sites/all/modules/civicrm/i/loading.gif") center right no-repeat, linear-gradient(top, #fff 0%, #eee 50%);
        }
